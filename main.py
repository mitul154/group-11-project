...
def compute_room_area(room_number, current_room): # Function to compute the area of the room
...
def compute_square_walls_area(): # Function to compute the area of the square walls
    length = int(input("Enter the length of the room in feet: ")) # User input to enter the length of the room
    return (length ** factor_of_square) * four_walls # Return the area of the square walls
...
for i in range(number_of_rooms): # For loop to compute the area of each room
    ...
    compute_room_area(number_of_rooms, i+1) # Call the function to compute the area of the room
